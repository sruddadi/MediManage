...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 style="color: black;">MEDIMANAGE</h3>
                    ...
                    <div class="media widget-ten">
                        ...
                        <div class="media-body media-text-right">
                            ...
                            if ($_SESSION["username"] == 'customer') {
                                $fn = $_SESSION['fname'];
                                $ln = $_SESSION['lname'];
                                $sql = "select * from `order` where `todays_date`= '" . date('Y-m-d') . "' and fname='$fn' and lname='$ln' ";
                            } else {
                    ...
                    <div class="media widget-ten">
                        ...
                        <div class="media-body media-text-right">
                            ...
                            if ($_SESSION["username"] == 'customer') {
                                $fn = $_SESSION['fname'];
                                $ln = $_SESSION['lname'];
                                $sql = "select * from `order` where `delivery_status`='0' and fname='$fn' and lname = '$ln'";
                            } else {
                    ...
                    <div class="media widget-ten">
                        ...
                        <div class="media-body media-text-right">
                            ...
                            if ($_SESSION["username"] == 'customer') {
                                $fn = $_SESSION['fname'];
                                $ln = $_SESSION['lname'];
                                $sql = "select * from `order` where `delivery_status`='1' and fname='$fn' and lname='$ln' ";
                            } else {
    ...
    <div class="card">
        <div class="card-body">
            <div class="col-md-5 align-self-center">
                <h3 style="color: black;">Appointment Status</h3>
            </div>

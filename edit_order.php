...
*/
  ...
  $q1 = "UPDATE `order` SET `sname`='" . $exp[0] . "',`discription`='$discription',`prizes`='" . $exp[1] . "',`delivery date`='$dod' WHERE `id`='" . $_GET['id'] . "'";
...
<div class="page-wrapper">
  ...
  <div class="row page-titles">
    <div class="col-md-5 align-self-center">
      <h3 style="color: #000000;">Edit appointment</h3>
    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <select name="sname" id="sname" class="form-control" required="">
                        ...
                        ?>
                          <option value="<?php echo $row2['id'] . ',' . $row2['prize']; ?>" <?php if ($row2['id'] == $sname) {
                                                                                              echo "selected";
                                                                                            } ?>> <?php echo $row2['sname']; ?> </option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
    ...
    <?php echo $discription; ?>
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <input type="number" readonly name="prizes" id="prizes" value="<?php echo $prizes; ?>">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <input type="date" name="dod" min=<?php echo $current_date ?> max="2023-12-31" class="form-control" placeholder="Delivery Date" value="<?php echo $dod; ?>">
                    </div>
                  </div>
                </div>

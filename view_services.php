...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <a href="del_services.php?id=<?php echo $_GET['id']; ?>" class="button button--success" data-for="js_success-popup">Yes</a>
    <a href="view_services" class="button button--error" data-for="js_success-popup">No</a>
    </p>
  </div>
</div>
<?php } ?>
  ...
  <!-- Page wrapper  -->
      ...
      <?php if(isset($useroles)){  if(in_array("add_services",$useroles)){ ?>
        <a href="add_services"><button class="btn btn-primary">Add Service</button></a>
                       <?php } } ?>
...
<a href="view_services?id=<?=$row['id'];?>"><button type="button" class="btn btn-xs btn-danger" ><i class="fa fa-trash"></i></button></a>
               <?php } } ?>

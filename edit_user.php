...
if (isset($_POST["btn_update"])) {
    ...
    $q1 = "UPDATE `admin` SET `fname`='$fname',`lname`='$lname',`address`='$address',`gender`='$gender',`contact`='$contact',`dob`='$dob' WHERE `id`='" . $_GET['id'] . "'";
    $q2 = "UPDATE `users` SET `fname`='$fname',`lname`='$lname' WHERE `email`= '$email'";
...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 style="color: #000000;">Edit employee</h3>
        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="text" name="email" class="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" placeholder="Email" value="<?php echo $email; ?>" readonly required>
